...
st.markdown('<div class="glass"><h2 class="title-accent">Dashboard</h2>', unsafe_allow_html=True)
...
with r1:
    radial_progress(st.session_state["progress"]["goal_path"], "Goal", "Squat Mobility")
with r2:
    radial_progress(st.session_state["progress"]["skill_tree"], "Skill", "Hip Mobility")
with r3:
    radial_progress(st.session_state["progress"]["pancake_strength"], "Pancake", "End-Range")
with r4:
    radial_progress(st.session_state["progress"]["weekly_volume_lower"], "Volume", "This Week")
st.markdown("</div>", unsafe_allow_html=True)
